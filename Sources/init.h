...
asm void initIrqVectors(void);			// interruption mode
void initINTC(void);					// autorise les interruptions
...
void initEMIOS_1();          			// Initialize eMIOS_1
void initEMIOS_0ch0(); 					// Initialize eMIOS 0 channel 0 as modulus counter 20ms
void initEMIOS_0ch23(); 				// Initialize eMIOS 0 channel 23 as modulus counter 125us
void initEMIOS_1ch23(); 				// Initialize eMIOS 1 channel 23 as modulus counter 125us
...
void initEMIOS_1ch11();	
void initEMIOS_1ch13();	
void initEMIOS_1ch15();	
